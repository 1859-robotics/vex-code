...
#pragma config(Motor,  port7,           B_CORE_LIFT,   tmotorVex393_MC29, openLoop, encoderPort, I2C_4)
#pragma config(Motor,  port8,           FLIP_LIFT,     tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_5)

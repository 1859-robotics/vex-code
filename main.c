...
#pragma config(Motor,  port1,           MANIPULATOR,   tmotorVex393_HBridge, openLoop, reversed, encoderPort, I2C_2)
#pragma config(Motor,  port2,           LB_DRIVE,      tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_1)
#pragma config(Motor,  port3,           LF_DRIVE,      tmotorVex393HighSpeed_MC29, openLoop)
#pragma config(Motor,  port5,           LIFT_CLAW,     tmotorVex393_MC29, openLoop, encoderPort, I2C_6)
#pragma config(Motor,  port6,           T_CORE_LIFT,   tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           B_CORE_LIFT,   tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_4)
#pragma config(Motor,  port8,           FLIP_LIFT,     tmotorVex393_MC29, openLoop, encoderPort, I2C_5)
#pragma config(Motor,  port9,           RF_DRIVE,      tmotorVex393HighSpeed_MC29, openLoop, reversed)
#pragma config(Motor,  port10,          RB_DRIVE,      tmotorVex393HighSpeed_HBridge, openLoop, reversed, encoderPort, I2C_3)

...
#pragma config(Motor,  port3,           FLIP_LIFT,     tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port8,           LIFT_CLAW,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port9,           R_MANIPULATOR, tmotorVex393_MC29, openLoop, reversed)

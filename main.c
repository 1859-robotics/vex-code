...
#pragma config(Motor,  port4,           FLIP_LIFT,     tmotorVex393HighSpeed_MC29, openLoop, encoderPort, I2C_3)
...
#pragma config(Motor,  port8,           LB_DRIVE,      tmotorVex393_MC29, openLoop, encoderPort, I2C_5)
